...
if [ `uname` == "Darwin" ];
then
  export DYLD_LIBRARY_PATH="/root/ros_ws/install/libfreenect/lib/fakenect/:${DYLD_LIBRARY_PATH}"
else
  export LD_LIBRARY_PATH="/root/ros_ws/install/libfreenect/lib/fakenect/:${LD_LIBRARY_PATH}"
fi
